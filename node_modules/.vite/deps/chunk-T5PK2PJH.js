...
function joinChildren(children, separator) {
  const childrenArray = React9.Children.toArray(children).filter(Boolean);
  return childrenArray.reduce((output, child, index) => {
    output.push(child);
    if (index < childrenArray.length - 1) {
      output.push(React9.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React9.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime3.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
...
true ? Stack.propTypes = {
   ...
   */
  divider: import_prop_types6.default.node,
  /**
   ...
   * @default false
   */
  useFlexGap: import_prop_types6.default.bool
} : void 0;
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React19.useState(idOverride);
  ...
  const Grid2 = React27.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime14.jsx)(GridRoot, {
      ...
      children: React27.Children.map(children, (child) => {
        var _a;
        if (React27.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-T5PK2PJH.js.map
