...
import {
  ...
  useForkRef,
  useForkRef_default
} from "./chunk-25POA4SH.js";
import {
  capitalize_default,
  memoTheme_default
} from "./chunk-MRYUDXQH.js";
import {
  _extends,
  alpha,
  composeClasses,
...
var NavigateBefore_default = createSvgIcon((0, import_jsx_runtime6.jsx)("path", {
...
var NavigateNext_default = createSvgIcon((0, import_jsx_runtime7.jsx)("path", {
...
var PaginationItem = React17.forwardRef(function PaginationItem2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPaginationItem"
  });
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime8.jsx)(PaginationItemEllipsis, {
    ref,
    ownerState,
    className: clsx_default(classes.root, className),
    children: "…"
  }) : (0, import_jsx_runtime8.jsxs)(PaginationItemPage, {
    ref,
    ownerState,
    component,
    disabled,
    className: clsx_default(classes.root, className),
    ...other,
    children: [type === "page" && page, IconSlot ? (0, import_jsx_runtime8.jsx)(PaginationItemPageIcon, {
      ...iconSlotProps,
...
true ? PaginationItem.propTypes = {
   ...
   * @default 'standard'
   */
  color: import_prop_types12.default.oneOfType([import_prop_types12.default.oneOf(["primary", "secondary", "standard"]), import_prop_types12.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
  ...
  components: import_prop_types12.default.shape({
    first: import_prop_types12.default.elementType,
    last: import_prop_types12.default.elementType,
    next: import_prop_types12.default.elementType,
    previous: import_prop_types12.default.elementType
  }),
  /**
   * If `true`, the component is disabled.
   * @default false
   ...
   */
  page: import_prop_types12.default.node,
  /**
   ...
   * @default 'circular'
   */
  shape: import_prop_types12.default.oneOf(["circular", "rounded"]),
  /**
  ...
  slotProps: import_prop_types12.default.shape({
    first: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    last: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    next: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]),
    previous: import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
   ...
   * @default 'page'
   */
  type: import_prop_types12.default.oneOf(["end-ellipsis", "first", "last", "next", "page", "previous", "start-ellipsis"]),
  /**
   * The variant to use.
   * @default 'text'
   */
  variant: import_prop_types12.default.oneOfType([import_prop_types12.default.oneOf(["outlined", "text"]), import_prop_types12.default.string])
} : void 0;
...
var Pagination = React18.forwardRef(function Pagination2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPagination"
  });
  const {
    ...
    onChange,
    page,
    renderItem = (item) => (0, import_jsx_runtime9.jsx)(PaginationItem_default, {
      ...item
    }),
    shape = "circular",
    showFirstButton = false,
  ...
  return (0, import_jsx_runtime9.jsx)(PaginationRoot, {
    "aria-label": "pagination navigation",
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other,
    children: (0, import_jsx_runtime9.jsx)(PaginationUl, {
      className: classes.ul,
      ownerState,
      children: items.map((item, index) => (0, import_jsx_runtime9.jsx)("li", {
        children: renderItem({
          ...item,
          color,
...
true ? Pagination.propTypes = {
   ...
   * @default 'standard'
   */
  color: import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf(["primary", "secondary", "standard"]), import_prop_types13.default.string]),
  /**
   ...
   * @default false
   */
  hideNextButton: import_prop_types13.default.bool,
  /**
   * If `true`, hide the previous-page button.
   * @default false
   */
  hidePrevButton: import_prop_types13.default.bool,
  /**
   ...
   * @default 'circular'
   */
  shape: import_prop_types13.default.oneOf(["circular", "rounded"]),
  /**
   ...
   * @default 'text'
   */
  variant: import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf(["outlined", "text"]), import_prop_types13.default.string])
} : void 0;
